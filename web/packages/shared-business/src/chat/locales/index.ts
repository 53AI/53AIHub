...
const CHAT_KEYS: readonly KeyRow[] = [
  ...
  ['chat.wiki', '动态知识', '動態知識', 'Dynamic Knowledge', 'ダイナミックナレッジ'],
  ['chat.select_from_library', '从知识库选择', '從知識庫選擇', 'Select from library', 'ライブラリから選択'],
  ['chat.select_from_knowledge', '选择指定内容', '選擇指定內容', 'Select specific content', '指定した内容を選択'],
  // 使用指引相关
  ...
  ['knowledge.document_file','知识文档','知識文檔','Knowledge Documents','ナレッジドキュメント'],
  ...
  ['chat.quotation_doc', '引用了 {{count}} 篇知识文档', '引用了 {{count}} 篇知識文檔', 'Referenced {{count}} knowledge documents', '{{count}}件のナレッジドキュメントを参照'],
  ['chat.quotation_wiki', '引用了 {{count}} 篇动态知识', '引用了 {{count}} 篇動態知識', 'Referenced {{count}} dynamic knowledge articles', '{{count}}件の動的知識を参照'],
  ['chat.quotation_mixed', '引用了 {{docCount}} 篇知识文档、{{wikiCount}} 篇动态知识', '引用了 {{docCount}} 篇知識文檔、{{wikiCount}} 篇動態知識', 'Referenced {{docCount}} knowledge documents and {{wikiCount}} dynamic knowledge articles', '{{docCount}}件のナレッジドキュメントと{{wikiCount}}件の動的知識を参照'],
  ...
  ['process.wiki_found', '从动态知识中检索到', '從動態知識中檢索到', 'From dynamic knowledge: ', '動的知識から: '],
  ['process.wiki_documents', '篇动态知识', '篇動態知識', ' dynamic knowledge articles', '件の動的知識'],
