...
func convertToRagChunkConfig(v2 *V2DocumentChunkingConfig) *rag.ChunkConfig {
	...
	config.IndexIncludeFileName = v2.ChildChunk.AppendFilename
...
func mergeChunkingConfig(dst *rag.ChunkConfig, src *rag.ChunkConfig) {
	...
	dst.KnowledgeIncludeFileName = src.KnowledgeIncludeFileName
	...
	dst.IndexIncludeFileName = src.IndexIncludeFileName
