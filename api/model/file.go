...
type File struct {
	...
	InsightSummary string `json:"insight_summary" gorm:"type:text;comment:'洞察和总结(Markdown格式,用于页面展示)'"`
...
func GetAllFilesByLibrary(eid int64, libraryID int64, sort string, fileType *int, runStatusValues []string) ([]File, error) {
	var files []File
